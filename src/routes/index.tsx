...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "Titan Criativos" },
    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          logo: "https://titan-content-craft.lovable.app/favicon.png",
      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          "@type": "FAQPage",
          mainEntity: [
            { "@type": "Question", name: "Fica óbvio que é IA?", acceptedAnswer: { "@type": "Answer", text: "NÃO. A gente usa IA pra criar movimento, som e efeitos profissionais. Resultado é indistinguível de um vídeo feito por editor caro." } },
            { "@type": "Question", name: "Quanto tempo leva entre eu mandar foto e receber?", acceptedAnswer: { "@type": "Answer", text: "48h é o padrão. Planos TITAN e SCALE têm prioridade e podem sair em 48-72h ou até menos." } },
            { "@type": "Question", name: "Posso pedir alterações infinitas?", acceptedAnswer: { "@type": "Answer", text: "Incluímos revisão em cada vídeo pra garantir que saia do jeito que você quer. Não é ilimitado eterno, mas também não te deixamos na mão se algo não ficou legal." } },
            ...
            { "@type": "Question", name: "Vocês fazem gestão de Instagram inteira?", acceptedAnswer: { "@type": "Answer", text: "Nosso foco é 100% produção de conteúdo — Reels, Stories, Carrosséis e legendas. Você continua no controle de quando e como postar." } },
            { "@type": "Question", name: "Se eu não gostar, consigo devolver?", acceptedAnswer: { "@type": "Answer", text: "Sim. Teste o primeiro mês. Se não fizer sentido pra sua loja, você cancela e não é cobrado de novo." } },
            { "@type": "Question", name: "Funciona pra qual tipo de loja?", acceptedAnswer: { "@type": "Answer", text: "Moda feminina, masculina, calçados e acessórios. Qualquer loja que vende produto visual e depende do Instagram pra vender se beneficia." } },
            { "@type": "Question", name: "Qual o valor mínimo por mês pra ficar interessante?", acceptedAnswer: { "@type": "Answer", text: "Lojas que faturam a partir de R$ 20k/mês no Instagram já sentem diferença real com o plano START." } },
          ],
        }),
      },
    ],
