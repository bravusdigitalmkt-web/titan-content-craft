...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Você envia as fotos. Nós criamos o conteúdo com Inteligência Artificial. Sua loja vende mais." },
      { name: "theme-color", content: "#09090B" },
      { property: "og:title", content: "Titan Criativos — Conteúdo com IA para lojas de moda" },
      { property: "og:description", content: "Você envia as fotos. Nós criamos o conteúdo com Inteligência Artificial. Sua loja vende mais." },
